...
export default function OperatorCard() {
  ...
  return (
    <div className="relative group w-full">
      ...
      {/* Main card box */}
      <div className="relative rounded-2xl border border-slate-200 dark:border-orange-500/30 bg-white dark:bg-[#141419] p-6 lg:p-10 overflow-hidden shadow-xl dark:shadow-2xl">
        ...
        <div className="relative w-44 h-44 sm:w-48 sm:h-48 mx-auto mb-8">
          ...
          {/* Avatar frame */}
          <div className="absolute inset-4 rounded-full overflow-hidden bg-slate-100 dark:bg-zinc-900 border border-slate-300 dark:border-zinc-700 shadow-inner">
            <Image
          ...
          <div className="absolute bottom-4 right-4 w-4 h-4 bg-emerald-500 rounded-full border-2 border-white dark:border-[#141419] shadow-[0_0_8px_rgba(16,185,129,0.8)] animate-pulse" />
        </div>
        ...
        <div className="font-code text-xs sm:text-sm space-y-3">
          <div className="flex justify-between items-center border-b border-slate-200 dark:border-zinc-800 pb-2">
            <span className="text-slate-500 dark:text-zinc-500">OPERATOR</span>
            <span className="text-orange-600 dark:text-orange-400 font-bold tracking-widest">
              {about.operatorName}
            </span>
          </div>

          <div className="flex justify-between items-center border-b border-slate-200 dark:border-zinc-800 pb-2">
            <span className="text-slate-500 dark:text-zinc-500">ROLE</span>
            <span className="text-sky-600 dark:text-sky-400 font-semibold">{about.role}</span>
          </div>

          <div className="flex justify-between items-center border-b border-slate-200 dark:border-zinc-800 pb-2">
            <span className="text-slate-500 dark:text-zinc-500">LOCATION</span>
            <span className="text-slate-800 dark:text-zinc-200">{about.location}</span>
          </div>

          <div className="flex justify-between items-center pt-1">
            <span className="text-slate-500 dark:text-zinc-500">STATUS</span>
            <span className="inline-flex items-center gap-1 rounded bg-emerald-500/10 border border-emerald-500/30 px-2 py-0.5 text-xs text-emerald-600 dark:text-emerald-400">
